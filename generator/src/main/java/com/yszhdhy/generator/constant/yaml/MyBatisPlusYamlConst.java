...
public enum MyBatisPlusYamlConst implements YamlTemplate {
    ...
    XML_PATH_DELETE_VALUE("mybatis-plus.mapper-locations", "classpath:"+ ModuleGroupId.MODULE_SERVICE_GROUP_ID.getModuleGroupId()+"/**/xml/*.xml"+",classpath:"+ ModuleGroupId.MODULE_SERVICE_GROUP_ID.getModuleGroupId()+"/**/**/mapper/*.xml"),
    ;
