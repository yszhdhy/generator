...
public class CommonElasticsearchDependencyBuilder extends Builder {
    ...
    public void builderDependency() {
        ...
        dependency.setArtifactId(ModulePath.MODULE_COMMON_ELASTICSEARCH_PATH.getModulePath().replaceAll("/",""));
