 ...
 */
public class VueModelFileBuilder {

    public static void construct() throws IOException {

        List<TemplateParametersDto> templateParametersList = TemplateParametersList.VUE_TEMPLATE_PACKAGES_LIST.getTemplateParametersList();
