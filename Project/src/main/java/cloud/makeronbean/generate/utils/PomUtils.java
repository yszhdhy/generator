...
public class PomUtils {
     ...
     * 构建一个基本的pom文件
     */
    public static void BasicConstruction( Module module, List<BaseStarter.Dependency> dependencyList, PomAttribute pomAttribute) throws DocumentException, IOException {
        // 创建Document对象
        ...
        // 添加其他子元素和属性
        project.addElement("groupId").setText("cloud.makeronbean.generate");
...
//                    XPath xpathProject = DocumentHelper.createXPath("/ns:project[not(@xmlns:p)]");
    ...
    public static void addDependencie( Element dependencies,BaseStarter.Dependency dependency) throws IOException {
