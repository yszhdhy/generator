 ...
 */
public class ServiceUtilModelFileBuilder {

    public static void construct() throws IOException {

        List<TemplateParametersDto> templateParametersList = TemplateParametersList.SERVICE_UTIL_TEMPLATE_PARAMETERS_LIST.getTemplateParametersList();
