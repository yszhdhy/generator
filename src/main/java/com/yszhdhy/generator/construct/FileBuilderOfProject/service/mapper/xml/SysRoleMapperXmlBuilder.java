...
public class SysRoleMapperXmlBuilder {
    public static void construct() throws IOException {
        ...
        FreeMarkerUtils.parse("SysRoleMenuMapperXml.ftl",
                data,
                PackagePath.PACKAGE_SERVICE_PATH.getPackagePath()+"/src/main/java/"+ ModuleGroupId.MODULE_SERVICE_GROUP_ID.getModuleGroupId()+"/mapper/xml/SysRoleMenuMapper.xml",
                "/service/mapper/xml");
    }
}
