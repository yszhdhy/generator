...
public class ViewsBuilder {
    ...
    public static void builderObj() throws IOException {
        ...
        vueFileVos.add(new VueFileVo("list.ftl","list",null,"/vue/src/views/system/sysMenu",".vue"));
        vueFileVos.add(new VueFileVo("assignAuth.ftl","assignAuth",null,"/vue/src/views/system/sysRole",".vue"));
        vueFileVos.add(new VueFileVo("list.ftl","list",null,"/vue/src/views/system/sysRole",".vue"));
        vueFileVos.add(new VueFileVo("list.ftl","list",null,"/vue/src/views/system/sysUser",".vue"));
