...
public class GuiguExceptionBuilder {
    ...
    public static void construct() throws IOException {
        ...
        data.put("packageNameResultCodeEnum",  ModuleGroupId.MODULE_COMMON_UTIL_GROUP_ID.getModuleGroupId().replaceAll("/","\\.")+".result.ResultCodeEnum");

        FreeMarkerUtils.parse("GuiguException.ftl",
                data,
